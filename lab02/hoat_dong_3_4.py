...
"""pow và toán tử hai cách này đều trả về kết quả giống nhau.tại vì pow là hàm, còn toán tử ** là toán tử.
divmod trả về một tuple gồm thương và dư của phép chia c cho d"""
