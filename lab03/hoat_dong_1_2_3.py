...
'''
Yêu cầu: giải thích sự khác nhau giữa remove() (xóa theo giá trị) và pop() (xóa theo vị trí
có trả về giá trị vừa
xóa).Hàm `remove()` và `pop()` trong Python đều được sử dụng để xóa phần tử khỏi danh sách
nhưng chúng có những khác biệt quan trọng:
'''
#Hoạt động 2
#2.1
print("Bài 2.1")
